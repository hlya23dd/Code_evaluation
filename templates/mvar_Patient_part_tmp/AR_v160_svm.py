...
def feature_train_test_split(my_feature, my_label, split_time=None, n_train=None):
  ...
  if n_train is not None:     
     segment_file_name_lables='train_filenames_labels_patient['+str(patient_index)+']_segment_length_['+str(segment_length_minutes)+'].csv' 
